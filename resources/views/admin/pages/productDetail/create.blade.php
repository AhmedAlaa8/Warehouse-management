...
@section('title')
      <title>Create Product Detail | Dashboard</title>
@endsection
      ...
      <div class="col-12">
            <div class="card">
                  <div class="card-header bg-primary">
                        <h3 class="card-title float-right">انشاء تفاصيل منتج جديدة</h3>
                  </div>

                  <form class="form-horizontal" method="POST" action="{{ route('admin.productDetail.store') }}">
                        @csrf
                        <div class="card-body">
                              ...
                              <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                          <input type="text" class="form-control @error('key') {{ 'is-invalid' }} @enderror" name="key" id="key" value="{{old('key')}}">
      ...
      <div class="row mb-2">
            ...
            <div class="col-sm-6">
                  <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">إنشاء تفاصيل المنتجات</li>
                  </ol>
            </div>
      </div>
@endsection
